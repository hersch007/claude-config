...
- [Client-facing branding](feedback-client-facing-branding.md) — default client deliverables use Start Performance + RBStart@StartPerformance.com; never GroupRB / richard@grouprb.com (SEO-Clients-Hub has 4 providers, see below)
- [SEO provider: always ask](feedback-seo-provider-always-ask.md) — never auto-pick the SEO audit provider company from CLIENT-BRIEF.md; always ask the user in chat
- [Parts of Practice brand](reference-parts-of-practice-brand.md) — navy #003366 + amber #f59e0b, Richard@PartsofPractice.com; don't guess these from a color-name description
