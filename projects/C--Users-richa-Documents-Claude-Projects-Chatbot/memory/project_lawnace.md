...
**LIVE SITE is `https://lawnace.com/` since 2026-09-10** (WP Engine + Cloudflare). `https://startwebservicesbackup.com/lawnace/` is the old staging/demo copy (Bluehost/Newfold) and may lag behind.
- Customer/client dashboard (Kyle's team, the ONLY external dashboard): `https://lawnace.com/la-team/` (use ?tab=tasks if the bare URL ever shows a stale cached page)
- WP admin dashboard: `https://lawnace.com/wp-admin/admin.php?page=lawnace-chat-logs` (sidebar: Lawnie)
